...
import { MobilePatternInsight, ProgressData, ScanHistoryEntry } from '../../../shared/types';
...
export class PatternIntelligenceEngine {
  ...
  public static analyzePatterns(history: ScanHistoryEntry[]): MobilePatternInsight[] {
    ...
    const insights: MobilePatternInsight[] = [];
