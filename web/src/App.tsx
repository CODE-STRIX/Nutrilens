...
export const App: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'dashboard' | 'patterns' | 'intelligence' | 'recalls' | 'learning'>('dashboard');
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-emerald-500 selection:text-slate-950">
      ...
      <footer className="border-t border-slate-800/80 bg-slate-950 py-6 mt-12 text-center text-xs text-slate-500">
        ...
        <p className="mt-1 text-[11px] text-slate-600">Smart India Hackathon 2026 • Team CODESTRIX • Web App Dashboard (Person A)</p>
      </footer>
