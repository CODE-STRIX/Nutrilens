...
import { MobileLearningLesson, ProductWithNutrition, ScanHistoryEntry, UserProfile } from '../../../shared/types';
...
export const SAMPLE_USER_PROFILE: UserProfile = {
  ...
  age: 34,
  gender: 'male',
  healthConditions: ['hypertension', 'diabetes_type_2'],
...
export const MOCK_LEARNING_LESSONS: MobileLearningLesson[] = [
  {
    id: 'lesson_1',
