...
export const HEALTH_CONDITIONS_META: Partial<Record<
  HealthCondition,
...
export const ALLERGIES_META: Partial<Record<Allergy, { label: string; keywords: string[] }>> = {
...
export const HEALTH_GOALS_META: Partial<Record<HealthGoal, { label: string; tag: string; description: string }>> = {
  weight_loss: {
    label: 'Weight Loss',
